...
function renderSermons(){const videos=['s1wsCuB_g_U','YsV4oHcb8ds','HXTHGLnlOD0','4UjLbqemQb4','KD9EkPTT0LI','qTYQzZQoNrM','HGpGR3A3izo','aQV0yfnPR8o','jSpPtPN-liQ'];$('#sermonList').innerHTML=videos.map((id,i)=>`<div class="sermon"><div class="sermon-label">Sunday Service ${videos.length-i}</div><div class="sermon-player"><iframe src="https://www.youtube.com/embed/${id}" title="MELGC Sunday Service ${videos.length-i}" loading="lazy" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div></div>`).join('')}
